...
你可以使用基于空中传输（OTA）的固件升级服务来升级设备固件。你可以参考以下示例代码。

你还可以在`<dir>/blob/master/src/main/java/com/envisioniot/enos/iot_mqtt_sdk/sample/OtaSample.java`获得该代码。
