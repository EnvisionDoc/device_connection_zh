...
latex_elements = {
    ...
    'preamble': r'''
        ...
        \fancyfoot[R]{\ifthenelse{\isodd{\value{page}}}{{\tiny EnOS 设备管理} }{\href{https://www.envisioniot.com}{\tiny IOT}}}
...
latex_documents = [
    (master_doc, u'EnOSDocumentationCenter.tex', u'设备管理',
     u'远景智能', 'book', 'true'),
]
...
texinfo_documents = [
    (master_doc, 'EnOSDocumentationCenter', 'EnOS Device Management',
     author, 'EnOSDocumentationCenter', 'Product documentation about EnOS Device Management.',
     'Miscellaneous'),
]
