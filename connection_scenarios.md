...
#### 场景1.3：接入设备未注册，通过可插拔采集信息动态注册<scenario1.3>
...
#### 场景2.1：接入子设备已注册，设备三元组已保存在Edge<scenario2.1>
...
#### 场景2.2：接入的子设备未注册，通过Edge动态注册<scenario2.2>
